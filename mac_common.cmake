...
# Modify the ICD JSON file to adjust the library path. The ICD JSON file goes in the Resources/vulkan/icd.d directory, so adjust the
# library_path to the relative path to the Frameworks directory in the bundle.. The regex does: substitute
# ':<whitespace>"<whitespace><all occurences of . and />' with: ': "../../../Frameworks/'
...
if(NOT ${CMAKE_GENERATOR} MATCHES "^Xcode.*") # Make sure we can find the 'ibtool' program. If we can NOT find it we  skip
