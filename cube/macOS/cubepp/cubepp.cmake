...
if(NOT ${CMAKE_GENERATOR} MATCHES "^Xcode.*") # Compile the storyboard file with the ibtool.
...
# Not sure this is needed.  When activated, it makes a symlink from libvulkan.dylib to libvulkan.1.dylib (which in turn symlinks to
# libvulkan.1.0.xx.dylib.) install(FILES "${CMAKE_BINARY_DIR}/loader/libvulkan.dylib" DESTINATION "demos/cubepp.app/Contents/MacOS"
# COMPONENT Runtime)
